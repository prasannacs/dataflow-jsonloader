 ...
 */
public class FitnessJSONPipeline {
	private static final Logger LOG = LoggerFactory.getLogger(FitnessJSONPipeline.class);

	public static void main(String[] args) {

		System.out.println("JSON Loader triggerred ..");
